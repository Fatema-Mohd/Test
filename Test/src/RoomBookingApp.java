...
public class RoomBookingApp {
    ...
    public RoomBookingApp(BookingService mockBookingService) {
    ...
    public static void main(String[] args, BookingService mockBookingService) {
        RoomBookingApp app = new RoomBookingApp(mockBookingService);
        app.start();
    }
}
